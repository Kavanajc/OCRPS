...
            var query = from Recipe in _context.Recipe
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutRecipe(int id, RecipeVM recipe)
        {
          try
            {
                if (recipe != null)
                {
                    ...
                    catObj.CategoryName = recipe.CategoryName;
                    ...
                    stateObj.StateName = (string)recipe.StateName;
                    ...
                    usersObj.UserName = recipe.UserName;
        ...
        public IActionResult SearchRecipeByState(string StateName)
        {
            var query = from Recipe in _context.Recipe
                        ...
                        where State.StateName.Contains(StateName)
                        select new
                        {
        ...
        public IActionResult SearchRecipeByCategoryVeg(string CategoryName)
        {
            var query = from Recipe in _context.Recipe
                        ...
                        join State in _context.State on Recipe.StateId equals State.StateId
                        join User in _context.Users on Recipe.UserId equals User.UserId
                        where Category.CategoryName == "VEG" 
                        select new
                        {
                            RecipeId = Recipe.RecipeId,
                            Title = Recipe.Title,
        ...
        public IActionResult SearchRecipeByCategoryNonVeg(string CategoryName)
        {
            var query = from Recipe in _context.Recipe
                        ...
                        join State in _context.State on Recipe.StateId equals State.StateId
                        join User in _context.Users on Recipe.UserId equals User.UserId
                        where Category.CategoryName == "NON VEG"
                        select new
                        {
                            RecipeId = Recipe.RecipeId,
                            Title = Recipe.Title,
